        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-lg border-0 rounded-4 text-center p-4 bg-light">
                    <img src="{{ asset('uploads/doctors/' . ($doctor->profile_pic ?? 'default.png')) }}" 
            ...
            <div class="col-lg-8">
                <!-- Tabs Navigation -->
                <ul class="nav nav-tabs mb-4" id="doctorProfileTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active fw-bold text-danger" id="location-tab" data-bs-toggle="tab" data-bs-target="#location" type="button" role="tab">📍 Practice Location</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-bold text-warning" id="availability-tab" data-bs-toggle="tab" data-bs-target="#availability" type="button" role="tab">🕑 Availability</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-bold text-success" id="about-tab" data-bs-toggle="tab" data-bs-target="#about" type="button" role="tab">👨‍⚕️ About Doctor</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-bold text-info" id="education-tab" data-bs-toggle="tab" data-bs-target="#education" type="button" role="tab">🎓 Education</button>
                    </li>
                </ul>
                            ...
                            <ul class="list-unstyled">
                                @forelse($doctor->educations as $edu)
                                    <li class="mb-3">
                                        ...
                                        <br>
                                        <small class="text-muted">{{ $edu->details ?? '' }}</small>
                                    </li>
                                @empty
