...
class MyHospitalController extends Controller
{
    ...
    public function index(Request $request){
        ...
        try{
            ...
            if($request->isMethod('post') && $request->ajax() && $request->session()->has('user_id')){
                ...
                $content_html =  view('doctor.myhospital.list-content')->with(['res'=> $records,'page'=>$page, 'page_size' => $page_size])->render();
                $pagination_html = view('pagination.pagination')->with(['url'=> 'myhospital', 'recTotal' => $total, 'pageSize' => $page_size, 'curPage' => $page,  'filterAjax' => 'ajaxSearching', 'filterType' => 'myhospital'])->render();
                ...
                $pagination_html = view('pagination.pagination')->with(['url'=> 'myhospital', 'recTotal' => $result['total_count'], 'pageSize' => $page_size, 'curPage' => $page,  'filterAjax' => 'ajaxSearching', 'filterType' => 'myhospital'])->render();
                $result['pagination_html'] = $pagination_html;
                $content_html =  view('doctor.myhospital.list-content')->with(['res'=> $records,'page'=>$page, 'page_size' => $page_size])->render();
                $result['content_html'] = $content_html;
            }
        ...
        $title = "Hospital List";
        return view('doctor.myhospital.index', compact('result', 'title')); 
    }
    ...
    public function add(Request $request){
        ...
        if($request->isMethod('post') && $request->ajax()){
            ...
            return view('doctor.myhospital.add', compact('hospital', 'specializations'));
        }
    }
    ...
    public function delete(Request $request, $id){
        ...
        return redirect('doctor/myhospital');  
    }
}
