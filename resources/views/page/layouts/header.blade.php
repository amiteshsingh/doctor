            ...
            <div class="row">
                <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="text-decoration-none text-body px-3" href=""><i class="bi bi-envelope me-2"></i>rogisewa25@gmail.com</a>
                    </div>
                </div>
                {{-- Social links (commented - add real social URLs to enable) --}}
